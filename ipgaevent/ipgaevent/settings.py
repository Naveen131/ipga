"""
Django settings for ipgaevent project.
...
WSGI_APPLICATION = 'ipgaevent.wsgi.application'
...
if USE_S3:
    ...
    STATICFILES_STORAGE = 'ipgaevent.storage_backends.StaticStorage'
    # s3 public media settings
    PUBLIC_MEDIA_LOCATION = 'media'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/'
    DEFAULT_FILE_STORAGE = 'ipgaevent.storage_backends.PublicMediaStorage'
